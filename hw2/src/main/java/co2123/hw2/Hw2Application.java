...
public class Hw2Application implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        article3.setIdentifier(3);
        article3.setVisits(26);
        article3 = articleRepository.save(article3);


        Journalist journalist3 = new Journalist();
        journalist3.setArticles(new ArrayList<>());
        journalist3.getArticles().add(article3);
        journalist3.setNewspapers(new ArrayList<>());
        journalist3.getNewspapers().add(newspaper1);
        journalist3.setSpeciality("Events");
        journalist3.setPopular(article3);
        journalist3 = journalistRepository.save(journalist3);
        ...
        newspaper1.getJournalists().add(journalist3);
